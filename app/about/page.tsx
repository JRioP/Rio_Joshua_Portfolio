...
export default function AboutPage() {
  ...
  return (
    ...
    {/* Photo + bio section */}
    <FadeIn as="section" className="w-full relative mt-20 overflow-visible" direction="up" delay={150}>
      <div className="flex flex-col md:flex-row gap-10 items-start">
        ...
        <div className="shrink-0">
          ...
          <div className="mt-4 flex items-center gap-2 font-mono text-sm text-green-400">
        ...
        <div className="flex-1 min-w-0">
          <h2 className="text-neutral-200 text-xl font-bold mb-4 tracking-tight">
      ...
      {/* Tech Stack Section */}
      <FadeIn as ="section" className="w-full relative mt-20 overflow-visible" direction="left" delay={0.15}>
      ...
      <FadeIn as ="section" className="w-full relative mt-20 overflow-visible" direction="right" delay={0.15}>
